    ...
    for count_p1 in range(ldim_p):
        for count_p2 in range(ldim_p):
            for count in range(len(indices_elements)):
                ...
                if photon: 
                    new_count_p1 = count_p2 
                    new_count_p2 = count_p1 
                else: 
                    new_count_p1 = count_p1
                    new_count_p2 = count_p2 
                if spin: 
                    # get the new index 
                    new_count = index_transpose_map[count] 
                else: 
                    new_count = count 
                    # replace rhos 
                ...
                new_rho[new_element_index] = rho[element_index]
